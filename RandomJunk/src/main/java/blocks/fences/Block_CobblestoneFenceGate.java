...
public class Block_CobblestoneFenceGate extends BlockHorizontal
{
    ...
    public Block_CobblestoneFenceGate()
    {
    	...
    	//Get Names
    	setUnlocalizedName(Reference.RandomJunkBlocks.COBBLESTONEFENCEGATE.getUnlocalizedName());
    	setRegistryName(Reference.RandomJunkBlocks.COBBLESTONEFENCEGATE.getRegistryName());
