...
public class Block_NetherBrickFenceGate extends BlockHorizontal {
	...
	public Block_NetherBrickFenceGate() {
		...
		//Get Names
		setUnlocalizedName(Reference.RandomJunkBlocks.NETHERBRICKFENCEGATE.getUnlocalizedName());
		setRegistryName(Reference.RandomJunkBlocks.NETHERBRICKFENCEGATE.getRegistryName());
