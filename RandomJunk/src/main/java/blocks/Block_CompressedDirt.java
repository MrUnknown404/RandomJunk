...
public class Block_CompressedDirt extends Block implements IMetaBlockName {
	
	public static final PropertyEnum TYPE = PropertyEnum.create("type", CompBlockTypes.class);
	
	public Block_CompressedDirt() {
		super(Material.ROCK);
		//
		setHardness(8.0f);
		...
		//Get Names
		setUnlocalizedName(Reference.RandomJunkBlocks.COMPRESSEDDIRT.getUnlocalizedName());
		setRegistryName(Reference.RandomJunkBlocks.COMPRESSEDDIRT.getRegistryName());
	}
