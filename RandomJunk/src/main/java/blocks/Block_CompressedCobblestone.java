...
public class Block_CompressedCobblestone extends Block implements IMetaBlockName {
	
	public static final PropertyEnum TYPE = PropertyEnum.create("type", CompBlockTypes.class);
	
	public Block_CompressedCobblestone() {
		super(Material.ROCK);
		//
		setHardness(8.0f);
		...
		//Get Names
		setUnlocalizedName(Reference.RandomJunkBlocks.COMPRESSEDCOBBLESTONE.getUnlocalizedName());
		setRegistryName(Reference.RandomJunkBlocks.COMPRESSEDCOBBLESTONE.getRegistryName());
	}
