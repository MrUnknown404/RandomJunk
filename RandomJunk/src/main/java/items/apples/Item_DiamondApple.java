...
public class Item_DiamondApple extends ItemFood {

	public Item_DiamondApple() {
		super(8, 0.6f, false);
	...
	public void onCreated(ItemStack stack, World worldIn, EntityPlayer playerIn) {
		...
		if (!playerIn.hasAchievement(AchievementHandler.Achievement_DiamondApple)) {
			playerIn.addStat(AchievementHandler.Achievement_DiamondApple);
		}
	}
}
