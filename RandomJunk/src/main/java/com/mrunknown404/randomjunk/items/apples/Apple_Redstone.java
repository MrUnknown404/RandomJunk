...
public class Apple_Redstone extends ItemFoodBase {

	public Apple_Redstone(String name, CreativeTabs tab, int amount, float saturation, boolean isWolfFood, boolean isAlwaysEdible) {
