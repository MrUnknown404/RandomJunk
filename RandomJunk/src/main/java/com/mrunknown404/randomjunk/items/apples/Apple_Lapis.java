...
public class Apple_Lapis extends ItemFoodBase {

	public Apple_Lapis(String name, CreativeTabs tab, int amount, float saturation, boolean isWolfFood, boolean isAlwaysEdible) {
