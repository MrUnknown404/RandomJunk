...
public class Apple_MagmaCream extends ItemFoodBase {

	public Apple_MagmaCream(String name, CreativeTabs tab, int amount, float saturation, boolean isWolfFood, boolean isAlwaysEdible) {
