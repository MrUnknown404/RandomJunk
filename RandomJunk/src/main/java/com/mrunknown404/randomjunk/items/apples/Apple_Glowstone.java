...
public class Apple_Glowstone extends ItemFoodBase {

	public Apple_Glowstone(String name, CreativeTabs tab, int amount, float saturation, boolean isWolfFood, boolean isAlwaysEdible) {
