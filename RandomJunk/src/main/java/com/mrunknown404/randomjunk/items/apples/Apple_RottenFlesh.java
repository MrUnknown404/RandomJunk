...
public class Apple_RottenFlesh extends ItemFoodBase {

	public Apple_RottenFlesh(String name, CreativeTabs tab, int amount, float saturation, boolean isWolfFood, boolean isAlwaysEdible) {
