...
public class PickupHandler {
	...
	public void pickup(EntityItemPickupEvent event) {
		...
		if(event.getItem().getItem().getItem() == Items.APPLE) {
		...
		if(event.getItem().getItem().getItem() == Items.FLINT) {
		...
		if(event.getItem().getItem().getItem() == Items.BONE) {
		...
		if(event.getItem().getItem().getItem() == ModItems.ObsidianShard) {
